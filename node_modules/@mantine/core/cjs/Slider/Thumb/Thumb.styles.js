...
var useStyles = styles.createStyles((theme, { color, size, disabled, thumbSize }) => ({
  label: {
    position: "absolute",
    top: -36,
  ...
  thumb: __spreadProps(__spreadValues({}, theme.fn.focusStyles()), {
    ...
    height: thumbSize || theme.fn.size({ sizes: SliderRoot_styles.sizes, size }) * 2,
    width: thumbSize || theme.fn.size({ sizes: SliderRoot_styles.sizes, size }) * 2,
