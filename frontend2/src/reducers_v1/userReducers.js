...
export const userDetailsReducerv1 = (state = { user: {} }, action) => {
  switch (action.type) {
...
export const Register_verifyReducer = (state = {}, action) => {
  switch (action.type) {
    case ACCOUNT_VERIFY_REQUEST:
    case ACCOUNT_VERIFY_REQUEST_SUCCESS:
      return {
        ...state,
        loading: true,
        error: null,
    ...
    case ACCOUNT_VERIFY_SUCCESS_SUCCESS:
      return {
        ...state,
        loading: false,
        message: action.payload,
    ...
    case ACCOUNT_VERIFY_FAIL_SUCCESS:
      return {
        ...state,
        loading: false,
        error: action.payload,
